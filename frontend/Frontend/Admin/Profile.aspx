...
">
    ...
    <div class="d-flex flex-column align-items-center">
        ...
        <h3 class="text-center text-white mt-2" style="font-weight: 1000;font-size:30px">lokesh shimpi</h3>
...
<i class="fa-solid fa-user-pen"></i></asp:LinkButton>
             ...
             <div class="col-12 pt-4">
                 <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control text-white">lokesh shimpi</asp:TextBox>
             </div>
